...
import project from "../assets/Projects/Zerene.png";
...
function Projects() {
  return (
    <>
      {/* Mobile/Tablet responsive title, Desktop exactly as original */}
      <h1
        id="projects"
      ...
      {/* Mobile/Tablet responsive container, Desktop exactly as original */}
      <div className="bg-black pb-10 lg:pb-20 relative px-4 ">
        {projects.map((data, index) => {
          return (
            ...
            >
              {/* Desktop: text-4xl pt-3, Mobile/Tablet: smaller */}
              <h1 className="text-white text-2xl sm:text-3xl lg:text-4xl pt-2 lg:pt-3 font-bold px-4 lg:px-0">
                {data.name}
              </h1>

              {/* Desktop: enlarged to w-[800px], Mobile: added rounded border */}
              <img
                className="w-[80%] 
                        rounded-[30px] p-4 lg:p-7 pb-2 
